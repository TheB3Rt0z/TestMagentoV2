 ...
 */
namespace Mediadivision\Gebana\Block\Adminhtml\Order\Create\Search;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addAttributeToSelect('interner_artikelname');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'qty_by_source',
            [
                'header' => __('Quantity by Source'),
                'renderer' => \MediaDivision\Gebana\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Quantity::class,
                'index' => 'qty'
            ]
        );
        $this->addColumn(
