...
use MediaDivision\Gebana\Helper\ImportOld as Helper;
...
class ImportOldshop extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setName("import:oldshop")
            ->setDescription("Produkte des alten Shops importieren")->setDefinition($options);
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $csvData = $this->helper->importOldProducts($this->debug);
