 ...
 */
namespace MediaDivision\Campaigns\Model\Rule\Metadata;
...
class ValueProvider extends \Magento\SalesRule\Model\Rule\Metadata\ValueProvider
{
    ...
    public function getMetadataValues(Rule $rule)
    {
        ...
        $campaignOptions = [['label' => 'keine Kampagne zugeordnet', 'value' => 0]];
        foreach ($this->campaignCollectionFactory->create() as $campaign) {
            $campaignOptions[] = [
                'label' => $campaign->getCode(),
